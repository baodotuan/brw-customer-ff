  ...
  Widget build(BuildContext context) {
    return AuthUserStreamWidget(
      child: StreamBuilder<OrdersRecord>(
        stream: OrdersRecord.getDocument(currentUserDocument?.inCartOrder),
                                                                  ...
                                                                  initialOption:
                                                                      dropDownValue ??=
                                                                          cartPageOrdersRecord
                                                                              .pickupAddress,
                                                                  options: dropDownCustomerAppSettingRecord
                                                                      .options
                                                                      .toList(),
                                                                  onChanged: (val) =>
                                                                      setState(() =>
                        ...
                        Padding(
                          ...
                          child: Stack(
                            children: [
                              Visibility(
                                visible:
                                    cartPageOrdersRecord.cashPayment ?? true,
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      10, 0, 10, 0),
                                  child: Row(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          InkWell(
                                                                            onTap:
                                                                              ...
                                                                              await currentUserDocument?.inCartOrder.update(ordersUpdateData);
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: Visibility(
                            visible:
                                (cartPageOrdersRecord.totalQuantity) != (0),
                            child: Padding(
                              padding:
                                            ...
                                            onTap: () async {
                                              ...
                                              final usersUpdateData = {
                                                ...
                                                'processing_order':
                                                  ...
                                                  cartPageOrdersRecord.reference
                                                ]),
                                              };
